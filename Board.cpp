...
namespace ariel{
 ...
 const int INIT = 5;
    ...
    void Board::post(unsigned int row, unsigned int column, Direction direction, std:: string mess) {
//
...
//        unsigned int new_col_len = column + ((direction == Direction::Horizontal) ? mess.length() : 0);
//        unsigned int new_row_len = row + ((direction == Direction::Vertical) ? mess.length() : 0);
...
//        }
//
//        for (char character: mess) {  //insert the post
...
//            unsigned int row_len = board.size();
//            //define the new size of the matrix
//            unsigned int new_col_len = 1+column + ((direction == Direction::Horizontal) ? len : 0);
//            unsigned int new_row_len = 1+row + ((direction == Direction::Vertical) ? len : 0);
//
//
//        // check the number of row
//        if (row_len < new_row_len) {
